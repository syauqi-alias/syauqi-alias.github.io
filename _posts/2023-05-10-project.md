...
# Pi-BLDC-Controller
*Still in development - 28/7/2025*

A project that part of Manufacturing Future Lab, under University College London. We have an Opentron here in our lab, and one of the researchers has requested can we design a custom hotplate magnetic stirrer to be placed inside the Opentron equipment. 
...
To be honest, I am quite nervous designing anything more than 5V. The motor we have in the lab to utilise was a [260W 30V/7A Maxon motor](https://www.maxongroup.com/en-gb/search?q=500266)

Schematic is *complete*, I have sent it out to multiple colleges and online forums to get their feedback on it. I have spent quite amount of time going back and forth on my component choice, it was a great learning process. I'll update along the process. 

<p>
  <img src="https://syauqi-alias.github.io/assets/Pi-BLDC-schematic.png"/>
</p>
